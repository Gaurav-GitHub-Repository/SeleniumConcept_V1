...
public class Dashboard1 {
	...
	private By Date_Picker1 = By.xpath("//input[@id='datepicker' and @class='hasDatepicker']");
	//WebElement for Date Picker 2
	private By Date_Picker2 = By.xpath("//input[@id='txtDate' and @name='SelectedDate']");
	//WebElement for choose file button 1
	//private By Choose_File1 = By.xpath("//*[@id='singleFileInput']"); 
	private By Choose_File1 = By.xpath("//form[@id='singleFileForm']/input"); 
	//WebElement to upload single file
	private By Single_FileButton = By.xpath("//button[text()='Upload Single File']");
	
	//Method to return date
	public By getDate_Picker1()
	{
		return Date_Picker1;
	}
	...
	//Method to return choose file xpath
	public By getChoose_File1()
	{
		return Choose_File1;
	}
	...
	public void setChoose_File1() throws InterruptedException
	{
		...
		driver.findElement(Single_FileButton).click();
