...
public class Dashboard4 {
	...
	private By search_tab = By.cssSelector("input.wikipedia-search-input");
	//WebElement for search button
	private By search_button = By.cssSelector("input.wikipedia-search-button");
	//WebElement for search result
	private By search_result = By.xpath("//div[@class='wikipedia-search-results']/div[1]/a");
	//WebElement for dynamic button
	private By dynamic_button = By.xpath("//div[@class='widget HTML' and @id='HTML5']/div/button");
	//WebElement for dynamic start button
	private By start_button = By.xpath("//button[text()='START']");
	//WebElement for dynamic stop button
	private By stop_button = By.xpath("//button[text()='STOP']");
	//WebElement for simple alert
	private By simple_alert = By.xpath("//button[text()='Simple Alert']");
	//WebElement for confirmation alert
	private By confirmation_alert = By.xpath("//button[text()='Confirmation Alert']");
	//WebElement for prompt alert
	private By prompt_alert = By.xpath("//button[text()='Prompt Alert']");
	//WebElement for new tab
	private By newtab_button = By.xpath("//button[text()-'New Tab']");
	//WebElement for poptab_button 
	private By popuptab_button = By.xpath("//button[text()='Popup Windows']");
	//WebElement for mouse hover button
	private By mousehover_button = By.xpath("//button[text()='Point Me']");
	//WebElement for double click button
	private By doubleclick = By.xpath("//button[text()='Copy Text']");
	//WebElement for input field2 text box
	private By inputtextbox2 = By.xpath("//div[@class='sidebar section']/div[7]/div/input[2]");
	//WebElement for drag and drop text
	private By dragAnddrop = By.xpath("//div[@class='sidebar section']/div[8]/h2");
	//WebElement for source element
	private By sourcelement = By.xpath("//div[@id='draggable']/p");
	//WebElement for target element
	private By targetelement = By.xpath("//div[@id='droppable']");			
	//WebElement for slider
	private By slider = By.xpath("//div[@id='slider-range']/span[1]");
	//WebElement for SVG red circle
	private By SVG_RedCircle = By.xpath("//div[@class='svg-container']//*[name()='svg'][1]");
	//WebElement for SVG green rectangle
	private By SVG_GreenRectangle = By.xpath("//div[@class='svg-container']//*[name()='svg'][3]");
	//WebElement SVG_BlueTriangle;
	private By SVG_BlueTriangle = By.xpath("//div[@class='svg-container']//*[name()='svg'][3]");
	//WebElement for scrolling dropdown textbox
	private By scrolltextbox = By.xpath("//input[@id='comboBox' and @type='text']");
	//WebElement for link
	private By link = By.xpath("//div[@id='laptops']/a[1]");
	
	//Method to return search tab xpath
	public By getenterSearch()
	{
		return search_tab;
	}
	...
	//Method to return search button xpath
	...
	//Method to return dynamic button xpath
	public By getDynamicButton1()
	{
	...
	//Method to return simple alert button xpath
	public By getSimpleAlert()
	{
		return simple_alert;
	}
	...
	//Method to return confirmation button xpath
	public By getConfirmationAlert()
	{
	...
	public void setConfirmationAlert()
	{
		...
		driver.findElement(confirmation_alert).click();
		Alert alert = driver.switchTo().alert();
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(20));
		wait.until(ExpectedConditions.alertIsPresent());
		String alerttext = alert.getText();
	...
	//Method to return prompt alert button xpath
	public By getPromptAlert()
	{
		return prompt_alert;
	}
	...
	//Method to retun new tab button xpath
	public By getWindow1()
	{
		return newtab_button;
	}
	...
	//Method to return pop up window button xpath
	public By getWindow2()
	{
		return popuptab_button;
	}
...
/*	//Method to click on multiple pop up window
	...
	//Method to return mouse hover button xpath
	public By getMouseHover()
	{
		return mousehover_button;
	}
	...
	//Method to retrieve double click button xpath
	...
	//Method to return drag and drop source xpath
	public By getdragAnddrop1()
	{
		return sourcelement;
	}
	//Method to return drag and drop target xpath
	public By getdragAnddrop2()
	{
	...
	//Method to return SVG red circle xpath
	public By getVerifySVGElement1()
	{
		return SVG_RedCircle;
	}
	//Method to return SVG red circle xpath
	public By getVerifySVGElement2()
	{
		return SVG_GreenRectangle;
	}
	//Method to return SVG red circle xpath
	public By getVerifySVGElement3()
	{
		return SVG_BlueTriangle;
	}
	...
	//Method to return scroll dropdown text box
	public By getScrollDropdown()
	{
		return scrolltextbox;
	}
