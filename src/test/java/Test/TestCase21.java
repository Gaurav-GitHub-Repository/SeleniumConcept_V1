...
public class TestCase21 extends browserconfig{


	@Description("Verify dynamic button")
	@Epic("TC_21")
	...
	public void functionaltest() throws InterruptedException 
	{
		...
		System.out.println(dashboard4.getDynamicButton1());
		System.out.println(dashboard4.getDynamicButton2());
	}
	@Test(priority=3)
	public void logout() 
	{
