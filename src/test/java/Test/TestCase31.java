...
public class TestCase31 extends browserconfig{
	...
	public void functionaltest() throws InterruptedException 
	{
		...
		System.out.println(dashboard4.getVerifySVGElement1());
		System.out.println(dashboard4.getVerifySVGElement2());
		System.out.println(dashboard4.getVerifySVGElement3());
	}
	@Test(priority=3)
	public void logout() 
	{
